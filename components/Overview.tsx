...
const Overview = (): JSX.Element => {
  ...
  return (
    <div className="flex gap-4 flex-wrap">
      <div className="overflow-hidden border bg-white rounded-md shadow-sm dark:bg-zinc-800 dark:border-zinc-500 w-full flex-0 md:flex-1">
        ...
        <div className="bg-zinc-50 p-4 font-medium border-t text-zinc-500 dark:bg-zinc-700 dark:text-zinc-400 dark:border-zinc-500 ">
      ...
      <div className="overflow-hidden border bg-white rounded-md shadow-sm dark:bg-zinc-800 dark:border-zinc-500 w-full flex-0 md:flex-1">
        <div className="flex items-center gap-4 mb-2 p-4">
          <div className="w-12 h-12 bg-gradient-to-b from-red-400 to-red-500 rounded-md flex items-center justify-center dark:from-red-600 dark:to-red-700">
      ...
      <div className="overflow-hidden border bg-white rounded-md shadow-sm dark:bg-zinc-800 dark:border-zinc-500 w-full flex-0 md:flex-1">
        <div className="flex items-center gap-4 mb-2 p-4">
          ...
          <div>
            <h3 className="text-slate-500 dark:text-slate-400 whitespace-nowrap">
              Available balance
            </h3>
            <h1 className="text-2xl font-bold dark:text-zinc-200 whitespace-nowrap">
