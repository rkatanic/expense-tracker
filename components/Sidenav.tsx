  ...
  return (
    <>
      ...
      <div
        ...
        } z-10 transition-[left] duration-300 fixed xl:z-0 xl:relative xl:left-0 overflow-y-auto p-4 w-full h-screen max-w-xs bg-zinc-100 border-r flex flex-col justify-between gap-8 dark:bg-zinc-700 dark:border-zinc-500`}
      >
        <div className="flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="before:absolute before:w-1 before:h-8 before:bg-orange-400 before:rounded-full before:left-2 flex gap-4 items-center font-semibold text-zinc-600 rounded-md p-2 bg-zinc-200 cursor-pointer dark:bg-zinc-600 dark:text-zinc-300">
              <FiList
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="font-semibold text-zinc-600 text-sm flex gap-4 items-center dark:text-zinc-300">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p
            ...
            className="flex gap-4 items-center text-sm font-semibold text-zinc-600 rounded-md p-2 hover:bg-zinc-200 cursor-pointer dark:hover:bg-zinc-600 dark:text-zinc-300"
          >
            <FiLogOut
              className="stroke-zinc-600 dark:stroke-zinc-400"
              size="1.25rem"
