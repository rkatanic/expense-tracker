  ...
  return (
    <>
      ...
      <div
        ...
        } z-10 transition-[left] duration-300 fixed xl:relative xl:left-0 overflow-y-auto p-4 w-full h-screen max-w-xs bg-zinc-100 border-r flex flex-col justify-between gap-8 dark:bg-zinc-800 xl:dark:bg-zinc-700/40 dark:border-zinc-700`}
      >
